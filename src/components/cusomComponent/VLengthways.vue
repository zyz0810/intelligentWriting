<template>
  <div>
    <div v-if="propValue.length != 0"
         class="lengthwaysProductBox">
      <div v-for="(item, index) in propValue"
           :key="index"
           class="product"
           draggable="true"
        ...
        <ul class="bottomBox">
          ...
          <li class="createSupplierName">
            规格：{{ item.specificationValue }}
          </li>
          <!--<li class="specificationValue">
            中包装：1{{ item.specificationValue }}
          </li>-->
          <!--
            <li class="manufacture" v-if="item.manufacture">
            {{ item.manufacture.name }}
          </li>
        -->
          <!-- <li class="retailPrice attachMoney"
          ...
          <li>
            <span class="retailPrice attachMoney"
                  v-if="item.retailPrice">{{item.retailPrice }}<span class='unit'>/{{item.unitName}}</span></span>
            <span class="marketPrice attachMoney"
                  v-if="item.marketPrice">{{item.marketPrice}}</span>
          </li>
          <!-- <li>

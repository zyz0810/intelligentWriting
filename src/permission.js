...
const whiteList = ['/login', '/auth-redirect','/template/index','/recently/index','/star/index','/share/index','/task/index','/my/index','/recycle/index','/vip/index'] // no redirect whitelist

...
const whiteList = ['/login', '/auth-redirect','/template/index','/recently/index','/star/index','/share/index','/task/index','/my/index','/recycle/index','/vip/index','/editor/index','/account/index'] // no redirect whitelist
